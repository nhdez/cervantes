...
export interface Theme {
  ...
  accent: string; accentSoft: string; warn: string; good: string; blue: string; shadow: string;
}
...
export const THEMES: Record<"light" | "dark", Theme> = {
  light: {
    ...
    warn: "oklch(0.62 0.13 70)", good: "oklch(0.55 0.10 145)", blue: "oklch(0.52 0.16 250)",
  ...
  dark: {
    ...
    warn: "oklch(0.74 0.12 75)", good: "oklch(0.68 0.10 145)", blue: "oklch(0.70 0.14 250)",
